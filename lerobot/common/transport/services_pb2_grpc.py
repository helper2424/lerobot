...
class AsyncInferenceStub:
    ...
    def __init__(self, channel):
        ...
        self.SendObservations = channel.stream_unary(
                ...
                request_serializer=lerobot_dot_common_dot_transport_dot_services__pb2.Observation.SerializeToString,
                response_deserializer=lerobot_dot_common_dot_transport_dot_services__pb2.Empty.FromString,
                _registered_method=True)
        self.GetActions = channel.unary_unary(
                '/transport.AsyncInference/GetActions',
                request_serializer=lerobot_dot_common_dot_transport_dot_services__pb2.Empty.SerializeToString,
                response_deserializer=lerobot_dot_common_dot_transport_dot_services__pb2.Actions.FromString,
                _registered_method=True)
        self.SendPolicyInstructions = channel.unary_unary(
                '/transport.AsyncInference/SendPolicyInstructions',
                request_serializer=lerobot_dot_common_dot_transport_dot_services__pb2.PolicySetup.SerializeToString,
                response_deserializer=lerobot_dot_common_dot_transport_dot_services__pb2.Empty.FromString,
                _registered_method=True)
        self.Ready = channel.unary_unary(
...
def add_AsyncInferenceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendObservations': grpc.stream_unary_rpc_method_handler(
                    ...
                    request_deserializer=lerobot_dot_common_dot_transport_dot_services__pb2.Observation.FromString,
                    response_serializer=lerobot_dot_common_dot_transport_dot_services__pb2.Empty.SerializeToString,
            ),
            'GetActions': grpc.unary_unary_rpc_method_handler(
                    servicer.GetActions,
                    request_deserializer=lerobot_dot_common_dot_transport_dot_services__pb2.Empty.FromString,
                    response_serializer=lerobot_dot_common_dot_transport_dot_services__pb2.Actions.SerializeToString,
            ),
            'SendPolicyInstructions': grpc.unary_unary_rpc_method_handler(
                    servicer.SendPolicyInstructions,
                    request_deserializer=lerobot_dot_common_dot_transport_dot_services__pb2.PolicySetup.FromString,
                    response_serializer=lerobot_dot_common_dot_transport_dot_services__pb2.Empty.SerializeToString,
            ),
            'Ready': grpc.unary_unary_rpc_method_handler(
                    servicer.Ready,
...
class AsyncInference:
    ...
    def SendObservations(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/transport.AsyncInference/SendObservations',
            lerobot_dot_common_dot_transport_dot_services__pb2.Observation.SerializeToString,
            lerobot_dot_common_dot_transport_dot_services__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def GetActions(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/transport.AsyncInference/GetActions',
            lerobot_dot_common_dot_transport_dot_services__pb2.Empty.SerializeToString,
            lerobot_dot_common_dot_transport_dot_services__pb2.Actions.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SendPolicyInstructions(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/transport.AsyncInference/SendPolicyInstructions',
            lerobot_dot_common_dot_transport_dot_services__pb2.PolicySetup.SerializeToString,
            lerobot_dot_common_dot_transport_dot_services__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
